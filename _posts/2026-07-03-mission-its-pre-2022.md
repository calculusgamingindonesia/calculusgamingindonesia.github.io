---
layout: default
title: "Soal dan Solusi MISSION ITS Bagian Presentasi 2022"
date: 2026-07-02
...
<div style="text-align: center; margin-bottom: 40px;">
    <h1 style="margin: 0; line-height: 1.3;">Soal dan Solusi MISSION ITS <br> Babak Presentasi 2022 </h1>
</div>
...
2. Diberikan barisan $(a_n)$ dan $(b_n)$ dengan

   $$a_n=\sum_{k=0}^\infty\dfrac{k^n}{k!}\quad\text{dan}\quad b_n=\sum_{k=0}^\infty(-1)^k\dfrac{k^n}{k!}$$

   untuk setiap $n\in\mathbb{N}$. Untuk setiap $n\in\mathbb{N}$, tunjukkan bahwa $a_nb_n$ adalah bilangan bulat.
