...
5. Diberikan $n, m\in\mathbb{N}$ dengan $n\leq m$. Buktikan bahwa
   ...
   $\det\begin{bmatrix}1&P_1^m&P_2^m&\ldots&P_n^m\\\\1&P_1^{m+1}&P_2^{m+1}&\cdots&P_n^{m+1}\\\\\hdots&\hdots&\hdots&\ddots&\hdots\\\\1&P_1^{m+n}&P_2^{m+n}&\cdots&P_n^{m+n}\end{bmatrix}=1!\cdot2!\cdot\ldots\cdot n!$.
