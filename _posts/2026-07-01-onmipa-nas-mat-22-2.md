...
2. Diberikan fungsi terbatas $f:[a, b]\to\mathbb{R}$ dan $x_0\in(a, b)$. Didefinisikan fungsi $p:(a, b)\to\mathbb{R}$ dengan $p(x)=\sup_{t\in[a, x]}f(t)$. Jika $f$ kontinu di $x_0$, selidiki apakah $p$ juga kontinu di $x_0$.
