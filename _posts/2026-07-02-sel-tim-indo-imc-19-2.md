---
layout: default
title: "Soal dan Solusi Seleksi Tim Indonesia Untuk IMC 2019 (Hari Kedua)"
date: 2026-07-02
...
3. Misalkan $f:[0, \infty)\to\mathbb{R}$ adalah fungsi kontinu yang turun tegas dan memenuhi $\lim_{x\to\infty}f(x)=0$. Buktikan bahwa
...
4. Ring $R$ dikatakan *cantik* jika memenuhi ketiga kondisi berikut.
   ...
   * (ii) $R$ bukan lapangan.
   * (iii) Setiap unsur di $R$ dapat dinyatakan secara tunggal sebagai jumlah dari suatu unsur yang memiliki invers dan suatu unsur yang tidak memiliki invers.<br><br>
