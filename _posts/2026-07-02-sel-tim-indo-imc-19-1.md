---
layout: default
title: "Soal dan Solusi Seleksi Tim Indonesia Untuk IMC 2019 (Hari Pertama)"
date: 2026-07-02
...
<div style="text-align: center; margin-bottom: 40px;">
    <h1 style="margin: 0; line-height: 1.3;">
        Soal dan Solusi Seleksi Tim Indonesia <br>
        Untuk IMC 2019 (Hari Pertama)
    </h1>
</div>
...
4. Misalkan $f:\mathbb{N}\cup\set{0}\to\mathbb{R}^+\cup\set{0}$ adalah fungsi yang memenuhi $f(n+m)\leq f(n)+f(m)$ untuk setiap $n, m\in\mathbb{N}\cup\set{0}$. Buktikan bahwa barisan $\bigg(\dfrac{f(n)}{n}\bigg)$ konvergen dengan $\displaystyle\lim_{n\to\infty}\dfrac{f(n)}{n}=\inf\bigg\\{\dfrac{f(n)}{n}:n\in\mathbb{N}\bigg\\}$.
