---
layout: default
title: "Soal dan Solusi Seleksi untuk Tim IMC Indonesia 2019 (Hari Kedua)"
date: 2026-07-02
...
<div style="text-align: center; margin-bottom: 40px;">
    <h1 style="margin: 0; line-height: 1.3;">Soal dan Solusi Seleksi untuk Tim <br> IMC Indonesia 2019 (Hari Kedua)</h1>
</div>
...
5. Misalkan $G$ adalah graf sederhana dengan titik-titik $v_1, v_2, \dots,$ dan $v_n$ serta rusuk-rusuk $e_1, e_2, \dots,$ dan $e_m$. Matriks insidensi $B=(b_{ij})$ dari $G$ adalah matriks berukuran $n\times m$ sedemikian sehingga $b_{ik}=1$ jika $v_i$ adalah ujung dari $e_k$ dan $b_{ik}=0$ jika tidak untuk setiap $i\in\set{1, 2, \dots, n}$ dan $k\in\set{1, 2, \dots, m}$. Misalkan $B(i, :)$ adalah baris ke-$i$ dari $B$ untuk setiap $i\in\set{1, 2, \dots, n}$. Untuk setiap $i, j\in\set{1, 2, \dots, n}$, didefinisikan *Hamming distance* $Hd(B(i, :), B(j, :))$ sebagai banyaknya $k\in\set{1, 2, \dots, m}$ yang memenuhi $B(i, k)\neq B(j, k)$. Didefinisikan juga
