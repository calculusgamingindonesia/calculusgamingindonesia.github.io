...
3. Diberikan polinomial kompleks $p$ dengan $p(z)=az^2+bz+c$ untuk setiap $z\in\mathbb{C}$.
   * (a) Jika $\set{\omega_0, \omega_1, \omega_2}$ adalah himpunan semua solusi dari persamaan $\omega^3=1$, tentukan nilai dari $\omega_0p(\omega_0)+\omega_1p(\omega_1)+\omega_2p(\omega_2)$.
